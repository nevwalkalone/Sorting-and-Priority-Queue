 ...
 * the range [0,1000000]. Number of folders for each txt file and number of txt
	...
	public static void main(String args[]) throws IOException {
		...
		for (int i = 1; i <= Text_Files; i++, text_file_number++) {
			...
			for (int j = 1; j < N; j++) {
				...
				// writing in each line of the text file a random number between 0 and 1.000.000
				if (j == N - 1) {
